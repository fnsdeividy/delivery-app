    ...
    <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border-l-4 border-blue-500">
          <div className="flex items-center">
            <TrendUp className="h-6 w-6 sm:h-8 sm:w-8 text-blue-500 flex-shrink-0" />
            <div className="ml-2 sm:ml-3 min-w-0 flex-1">
              <p className="text-xs sm:text-sm font-medium text-gray-500 truncate">
                Em Andamento
              </p>
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border-l-4 border-green-500">
          <div className="flex items-center">
            <CurrencyDollar className="h-6 w-6 sm:h-8 sm:w-8 text-green-500 flex-shrink-0" />
            <div className="ml-2 sm:ml-3 min-w-0 flex-1">
              <p className="text-xs sm:text-sm font-medium text-gray-500 truncate">
                Receita Total
              </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3">
        ...
        <div className="bg-orange-50 p-2 sm:p-3 rounded-lg border border-orange-200">
          <div className="flex items-center">
            ...
            <div className="ml-1 sm:ml-2 min-w-0 flex-1">
              <p className="text-xs font-medium text-orange-900 truncate">
                Preparando
              </p>
