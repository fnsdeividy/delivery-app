    ...
    <div className="space-y-3 mb-6">
      {promotions
        ...
        .map((promotion) => (
          <div
            key={promotion.id}
            className="bg-gradient-to-r from-purple-50 to-purple-50 border border-purple-200 rounded-lg p-4"
          >
            <div className="flex items-start">
              ...
              <div className="ml-auto pl-3">
                <button
                  ...
                  className="inline-flex text-purple-400 hover:text-purple-600"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
