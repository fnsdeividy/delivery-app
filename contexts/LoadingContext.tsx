...
interface LoadingContextType {
  ...
  setLoading: (isLoading: boolean, options?: Partial<Omit<LoadingState, 'isLoading'>>) => void;
  startRouteLoading: (route: string, options?: Partial<Omit<LoadingState, 'isLoading'>>) => void;
...
export function LoadingProvider({ children }: LoadingProviderProps) {
  ...
  const startRouteLoading = useCallback((
    ...
    setLoading(true, {
      loadingMessage: `Navegando para ${route}...`,
      variant: 'topbar',
      ...options,
    });
  }, [setLoading]);
...
export function useLoadingContext() {
  ...
  if (context === undefined) {
    throw new Error('useLoadingContext deve ser usado dentro de um LoadingProvider');
  }
  return context;
}