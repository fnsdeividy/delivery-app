...
export const createResponsiveAnimation = (
  ...
  const presetFn = animationPresets[preset];
  if (preset === "slideIn") {
    return presetFn("up", {
      ...options,
      mobile: isMobile,
      duration: isMobile
        ? responsiveConfig.mobile.duration
        : responsiveConfig.desktop.duration,
      stagger: isMobile
        ? responsiveConfig.mobile.stagger
        : responsiveConfig.desktop.stagger,
    });
  }

  return (presetFn as any)({
    ...options,
    mobile: isMobile,
    duration: isMobile
      ? responsiveConfig.mobile.duration
