            ...
            <div className="animate-slide-in-left stagger-item">
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-black text-black focus:outline-none focus:ring-blue-500 focus:border-blue-500 search-focus transition-all duration-300"
                />
              </div>
            ...
            <div className="animate-slide-in-left stagger-item">
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="appearance-none block w-full px-3 py-2 pr-10 border border-gray-300 rounded-md placeholder-black text-black focus:outline-none focus:ring-blue-500 focus:border-blue-500 search-focus transition-all duration-300"
                />
                <button
                  type="button"
