            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Monitore todos os pedidos do sistema
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <p className="text-gray-600">
            Esta seção permite visualizar e gerenciar todos os pedidos de todas
            as lojas do sistema. Use os filtros para encontrar pedidos
            específicos e monitore o status em tempo real.
          </p>
        </div>
